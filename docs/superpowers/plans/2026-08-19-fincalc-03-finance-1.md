...
class SmplTest {
    ...
    fun `manual example 365 basis`() {
        ...
        assertEquals(-164.3835616, Smpl.si(120.0, 5.0, 10000.0, 365), 1e-9)
        assertEquals(-10164.38356, Smpl.sfv(120.0, 5.0, 10000.0, 365), 1e-9)
    }

    @Test
    fun `basis 360`() {
        // SI′ = 120/360 × 10000 × 0.05 = 166.66…
        assertEquals(-166.6666667, Smpl.si(120.0, 5.0, 10000.0, 360), 1e-9)
        assertEquals(-10166.66667, Smpl.sfv(120.0, 5.0, 10000.0, 360), 1e-9)
    }
